...
public class CursoDAO {
    ...
    public boolean RegistrarCurso(Curso curso) {
        ...
        try {
            ...
            System.out.println("Error --> DAO --> Curso --> Registrar  " + e.getMessage());
            e.printStackTrace();
        }
        return retornar;
    }
    ...
    public boolean ActualizarCurso(Curso curso) {
        ...
        try {
            ...
            System.out.println("Error --> DAO --> Curso --> Actualizar " + e.getMessage());
            e.printStackTrace();
        }
        return retornar;
    }
    ...
    public boolean EliminarCurso(Curso curso) {
        ...
        try {
            ...
            System.out.println("ERROR --> DAO --> Curso --> Eliminar " + e.getMessage());
            e.printStackTrace();
        }
        return retornar;
    }
    ...
    public List<Curso> ListarCurso() {
        ...
        try {
            ...
            System.out.println("Error --> DAO --> Curso --> Listar ");
            e.printStackTrace();
        }
        return listarCurso;
    }
    ...
    public List<Curso> BuscarCurso(String nomLar) {
        ...
        try {
            Connection con = Conexion.getConnection();
            PreparedStatement pstm = con.prepareStatement("select id,nombreCorto,nombreLargo,horasTecnicas,horasPracticas,descripcion "
                    + "from curso where estado=1 and nombreLargo like '%" + nomLar + "%'");
            ResultSet rst = pstm.executeQuery();
            while (rst.next()) {
                Curso c = new Curso();
            ...
            System.out.println("ERROR --> DAO --> CURSO --> BUSCAR");
            e.printStackTrace();
        }
        return listarCurso;
    }
